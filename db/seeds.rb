...
cards = [
  ...
  #lesson 6
  {"front" => "田", "back" => "field", "pronunciation" => "tián", "chapter" => "6", "new" => "no"},
  {"front" => "力", "back" => "strenth", "pronunciation" => "lì", "chapter" => "6", "new" => "no"},
  {"front" => "男", "back" => "male", "pronunciation" => "nán", "chapter" => "6", "new" => "no"},
  {"front" => "里", "back" => "mile, village, inside", "pronunciation" => "lǐ", "chapter" => "6", "new" => "no"},
  {"front" => "胃", "back" => "stomach", "pronunciation" => "wèi", "chapter" => "6", "new" => "no"},
  {"front" => "王", "back" => "king", "pronunciation" => "wáng", "chapter" => "6", "new" => "no"},
  {"front" => "玉", "back" => "jade", "pronunciation" => "yù", "chapter" => "6", "new" => "no"},
  {"front" => "宝", "back" => "precious", "pronunciation" => "bǎo", "chapter" => "6", "new" => "no"},
  {"front" => "主", "back" => "master", "pronunciation" => "zhǔ", "chapter" => "6", "new" => "no"},
  {"front" => "住", "back" => "to live, to stay", "pronunciation" => "zhù", "chapter" => "6", "new" => "no"},
  {"front" => "街", "back" => "street", "pronunciation" => "jiē", "chapter" => "6", "new" => "no"},
  {"front" => "号", "back" => "number", "pronunciation" => "hào", "chapter" => "6", "new" => "no"},
  {"front" => "个", "back" => "(measure word)", "pronunciation" => "gé", "chapter" => "6", "new" => "no"},
  {"front" => "只", "back" => "only", "pronunciation" => "zhǐ", "chapter" => "6", "new" => "no"},
  {"front" => "两", "back" => "two", "pronunciation" => "liǎng", "chapter" => "6", "new" => "no"},
  {"front" => "和", "back" => "and", "pronunciation" => "hé", "chapter" => "6", "new" => "no"},
  {"front" => "玩", "back" => "to play", "pronunciation" => "wán", "chapter" => "6", "new" => "no"},
  {"front" => "人力", "back" => "man power", "pronunciation" => "rén lì", "chapter" => "6", "new" => "no"},
  {"front" => "男人", "back" => "man", "pronunciation" => "nán rén", "chapter" => "6", "new" => "no"},
  {"front" => "女王", "back" => "queen", "pronunciation" => "nǚ wáng", "chapter" => "6", "new" => "no"},
  {"front" => "国王", "back" => "king (usage)", "pronunciation" => "guó wáng", "chapter" => "6", "new" => "no"},
  {"front" => "王子", "back" => "prince", "pronunciation" => "wáng zi", "chapter" => "6", "new" => "no"},
  {"front" => "王国", "back" => "kingdom", "pronunciation" => "wáng guó", "chapter" => "6", "new" => "no"},
  {"front" => "国家", "back" => "country, state, nation", "pronunciation" => "guó jiā", "chapter" => "6", "new" => "no"},
  {"front" => "国土", "back" => "territory", "pronunciation" => "guó tǔ", "chapter" => "6", "new" => "no"},
  {"front" => "主人", "back" => "host", "pronunciation" => "zhǔ rén", "chapter" => "6", "new" => "no"},
  {"front" => "胃口", "back" => "appetite", "pronunciation" => "wèi kǒu", "chapter" => "6", "new" => "no"},
  {"front" => "住处", "back" => "living place", "pronunciation" => "zhù chù", "chapter" => "6", "new" => "no"},
  {"front" => "地址", "back" => "address", "pronunciation" => "dì zhǐ", "chapter" => "6", "new" => "no"},
  {"front" => "房子", "back" => "house", "pronunciation" => "fáng zi", "chapter" => "6", "new" => "no"},
  {"front" => "房间", "back" => "room", "pronunciation" => "fáng jiān", "chapter" => "6", "new" => "no"},
  {"front" => "欢迎", "back" => "to welcome", "pronunciation" => "huān yíng", "chapter" => "6", "new" => "no"},
  {"front" => "一定", "back" => "certainly", "pronunciation" => "yí dìng", "chapter" => "6", "new" => "no"},
  {"front" => "吗先生，请来我住处玩", "back" => "Mr Ma, Please come and visit my place", "pronunciation" => "mǎ xiān sheng, qǐng lái wǒ zhù chù wán.", "chapter" => "6", "new" => "no"},
  {"front" => "好的。你住哪里", "back" => "Alright. Where do you live?", "pronunciation" => "hǎo de. nǐ zhù nǎ lǐ", "chapter" => "6", "new" => "no"},
  {"front" => "握住在...", "back" => "I live in ...", "pronunciation" => "wǒ zhù zài ...", "chapter" => "6", "new" => "no"},
  {"front" => "这是我的地址", "back" => "this is my address", "pronunciation" => "zhè shì wǒ de dì zhǐ", "chapter" => "6", "new" => "no"},
  {"front" => "...街十八号", "back" => "18 ... street", "pronunciation" => "...jiē shí bā hào", "chapter" => "6", "new" => "no"},
  {"front" => "这房子大不大", "back" => "Is this house big?", "pronunciation" => "zhè fáng zi dà bú dà", "chapter" => "6", "new" => "no"},
  {"front" => "不大，只有两个房间", "back" => "No, it only has two rooms", "pronunciation" => "bú dà, zhǐ yǒu liǎng gé fáng jiān", "chapter" => "6", "new" => "no"},
  {"front" => "你一个人住吗？", "back" => "Do you live by yourself?", "pronunciation" => "nǐ yí gé rén zhù ma?", "chapter" => "6", "new" => "no"},
  {"front" => "不，我和一个奥大剌亚朋友住。欢迎你来玩", "back" => "No, I live with an Australian friend. You are welcome to my place", "pronunciation" => "bù, wǒ hé yí gé ào dà lì ya4 péng you zhù huān yíng nǐ lái wán.", "chapter" => "6", "new" => "no"},
  {"front" => "谢谢，我一定来", "back" => "Thank you, I will certainly come.", "pronunciation" => "xiè xie, wǒ yí dìng lái", "chapter" => "6", "new" => "no"},

  #lesson 7
  {"front" => "木", "back" => "tree, wood", "pronunciation" => "mù", "chapter" => "7", "new" => "no"},
  {"front" => "林", "back" => "forest", "pronunciation" => "lín", "chapter" => "7", "new" => "no"},
  {"front" => "森", "back" => "dense forest", "pronunciation" => "sēn", "chapter" => "7", "new" => "no"},
  {"front" => "梦", "back" => "dream", "pronunciation" => "mèng", "chapter" => "7", "new" => "no"},
  {"front" => "休", "back" => "rest", "pronunciation" => "xiū", "chapter" => "7", "new" => "no"},
  {"front" => "本", "back" => "root", "pronunciation" => "běn", "chapter" => "7", "new" => "no"},
  {"front" => "体", "back" => "body", "pronunciation" => "tǐ", "chapter" => "7", "new" => "no"},
  {"front" => "李", "back" => "plum", "pronunciation" => "lǐ", "chapter" => "7", "new" => "no"},
  {"front" => "果", "back" => "fruit", "pronunciation" => "guǒ", "chapter" => "7", "new" => "no"},
  {"front" => "几", "back" => "how many, how much, which, some, a few", "pronunciation" => "jǐ", "chapter" => "7", "new" => "no"},
  {"front" => "点", "back" => "o'clock", "pronunciation" => "diǎn", "chapter" => "7", "new" => "no"},
  {"front" => "差", "back" => "less", "pronunciation" => "chà", "chapter" => "7", "new" => "no"},
  {"front" => "分", "back" => "minute", "pronunciation" => "fēn", "chapter" => "7", "new" => "no"},
  {"front" => "急", "back" => "urgent", "pronunciation" => "jí", "chapter" => "7", "new" => "no"},
  {"front" => "事", "back" => "matter, thing", "pronunciation" => "shì", "chapter" => "7", "new" => "no"},
  {"front" => "要", "back" => "to want", "pronunciation" => "yào", "chapter" => "7", "new" => "no"},
  {"front" => "会", "back" => "can, be able to, meeting, conference", "pronunciation" => "huì", "chapter" => "7", "new" => "no"},
  {"front" => "半", "back" => "half", "pronunciation" => "bàn", "chapter" => "7", "new" => "no"},
  {"front" => "才", "back" => "just", "pronunciation" => "cái", "chapter" => "7", "new" => "no"},
  {"front" => "还", "back" => "still", "pronunciation" => "hái", "chapter" => "7", "new" => "no"},
  {"front" => "呢", "back" => "a modal particle", "pronunciation" => "ne", "chapter" => "7", "new" => "no"},
  {"front" => "想", "back" => "would like to, to think", "pronunciation" => "xiǎng", "chapter" => "7", "new" => "no"},
  {"front" => "木工", "back" => "woodwork", "pronunciation" => "mù gōng", "chapter" => "7", "new" => "no"},
  {"front" => "森林", "back" => "forest (usage)", "pronunciation" => "sēn lín", "chapter" => "7", "new" => "no"},
  {"front" => "做梦", "back" => "to dream", "pronunciation" => "zuò mèng", "chapter" => "7", "new" => "no"},
  {"front" => "梦见", "back" => "see in a dream", "pronunciation" => "mèng jiàn", "chapter" => "7", "new" => "no"},
  {"front" => "休息", "back" => "rest (usage)", "pronunciation" => "xiū xi", "chapter" => "7", "new" => "no"},
  {"front" => "本子", "back" => "notebook", "pronunciation" => "běn zi", "chapter" => "7", "new" => "no"},
  {"front" => "日本", "back" => "Japan", "pronunciation" => "rì běn", "chapter" => "7", "new" => "no"},
  {"front" => "身体", "back" => "body, health", "pronunciation" => "shēn tǐ", "chapter" => "7", "new" => "no"},
  {"front" => "李子", "back" => "plum (usage)", "pronunciation" => "lǐ zi", "chapter" => "7", "new" => "no"},
  {"front" => "水果", "back" => "fruits", "pronunciation" => "shuǐ guǒ", "chapter" => "7", "new" => "no"},
  {"front" => "现在", "back" => "now", "pronunciation" => "xiàn zài", "chapter" => "7", "new" => "no"},
  {"front" => "开会", "back" => "to attend a meeting", "pronunciation" => "kāi huì", "chapter" => "7", "new" => "no"},
  {"front" => "时侯", "back" => "time", "pronunciation" => "shí hòu", "chapter" => "7", "new" => "no"},
  {"front" => "开始", "back" => "to start", "pronunciation" => "kāi shǐ", "chapter" => "7", "new" => "no"},
  {"front" => "下午", "back" => "afternoon", "pronunciation" => "xià wǔ", "chapter" => "7", "new" => "no"},
  {"front" => "那么", "back" => "then", "pronunciation" => "nà me", "chapter" => "7", "new" => "no"},
  {"front" => "再见", "back" => "goodbye", "pronunciation" => "zài jiàn", "chapter" => "7", "new" => "no"},
  {"front" => "办公室", "back" => "office", "pronunciation" => "bàn gōng shì", "chapter" => "7", "new" => "no"},
  {"front" => "请问，现在几点？", "back" => "excuse me what time is it now?", "pronunciation" => "qǐng wèn, xiàn zài jǐ diǎn?", "chapter" => "7", "new" => "no"},
  {"front" => "一点差无分", "back" => "Five to one", "pronunciation" => "yì diǎn chà wǔ fēn", "chapter" => "7", "new" => "no"},
  {"front" => "你有什么急事？", "back" => "Do you have an urgent matter?", "pronunciation" => "nǐ yǒu shén me jí shì", "chapter" => "7", "new" => "no"},
  {"front" => "我要去大学开会", "back" => "I must go to the university for a meeting.", "pronunciation" => "wǒ yào gù dà xué kāi huì", "chapter" => "7", "new" => "no"},
  {"front" => "会什么时侯开始？", "back" => "At what time does the meeting start?", "pronunciation" => "huì shén me shí hòu kāi shǐ", "chapter" => "7", "new" => "no"},
  {"front" => "下午两点半", "back" => "2:30 pm", "pronunciation" => "xià wǔ liǎng diǎn bàn", "chapter" => "7", "new" => "no"},
  {"front" => "现在才一点，还早呢", "back" => "It's just one o'clock now. It is still early.", "pronunciation" => "xiàn zài cái yì diǎn, hái zǎo ne", "chapter" => "7", "new" => "no"},
  {"front" => "这几天，我身体不好", "back" => "These few days, I'm not feeling well.", "pronunciation" => "zhè jǐ tiān, wǒ shēn tǐ bú hǎo", "chapter" => "7", "new" => "no"},
  {"front" => "我想先去办公室休息一下", "back" => "I'd like to go to the office and have a rest first.", "pronunciation" => "wǒ xiǎng xiān gù bàn gōng shì xiū xi yí xià", "chapter" => "7", "new" => "no"},
  {"front" => "那么再见", "back" => "Then, goodbye", "pronunciation" => "nà me, zài jiàn", "chapter" => "7", "new" => "no"},

  #lesson 8
  {"front" => "言", "back" => "words", "pronunciation" => "yán", "chapter" => "8", "new" => "no"},
  {"front" => "信", "back" => "letter", "pronunciation" => "xìn", "chapter" => "8", "new" => "no"},
  {"front" => "计", "back" => "plan", "pronunciation" => "jì", "chapter" => "8", "new" => "no"},
  {"front" => "舌", "back" => "tongue", "pronunciation" => "shé", "chapter" => "8", "new" => "no"},
  {"front" => "话", "back" => "talk", "pronunciation" => "huà", "chapter" => "8", "new" => "no"},
  {"front" => "兑", "back" => "exchange", "pronunciation" => "duì", "chapter" => "8", "new" => "no"},
  {"front" => "说", "back" => "speak", "pronunciation" => "shuō", "chapter" => "8", "new" => "no"},
  {"front" => "谢", "back" => "thank", "pronunciation" => "xiè", "chapter" => "8", "new" => "no"},
  {"front" => "课", "back" => "class", "pronunciation" => "kè", "chapter" => "8", "new" => "no"},
  {"front" => "进", "back" => "to come in", "pronunciation" => "jìn", "chapter" => "8", "new" => "no"},
  {"front" => "喝", "back" => "to drink", "pronunciation" => "hē", "chapter" => "8", "new" => "no"},
  {"front" => "茶", "back" => "tea", "pronunciation" => "chá", "chapter" => "8", "new" => "no"},
  {"front" => "糖", "back" => "sugar", "pronunciation" => "táng", "chapter" => "8", "new" => "no"},
  {"front" => "做", "back" => "to do", "pronunciation" => "zuò", "chapter" => "8", "new" => "no"},
  {"front" => "写", "back" => "to write", "pronunciation" => "xiè", "chapter" => "8", "new" => "no"},
  {"front" => "快", "back" => "quick, soon", "pronunciation" => "kuài", "chapter" => "8", "new" => "no"},
  {"front" => "对", "back" => "right, yes", "pronunciation" => "duì", "chapter" => "8", "new" => "no"},
  {"front" => "方言", "back" => "dialect", "pronunciation" => "fāng yán", "chapter" => "8", "new" => "no"},
  {"front" => "信心", "back" => "confidence", "pronunciation" => "xìn xīn", "chapter" => "8", "new" => "no"},
  {"front" => "写信", "back" => "write letters", "pronunciation" => "xiè xìn", "chapter" => "8", "new" => "no"},
  {"front" => "小说", "back" => "novel", "pronunciation" => "xiǎo shuō", "chapter" => "8", "new" => "no"},
  {"front" => "说明", "back" => "explain", "pronunciation" => "shuō míng", "chapter" => "8", "new" => "no"},
  {"front" => "说话", "back" => "to speak", "pronunciation" => "shuō huà", "chapter" => "8", "new" => "no"},
  {"front" => "硕大话", "back" => "talk big, boast", "pronunciation" => "shuō dà huà", "chapter" => "8", "new" => "no"},
  {"front" => "上课", "back" => "go to class", "pronunciation" => "shàng kè", "chapter" => "8", "new" => "no"},
  {"front" => "下课", "back" => "class over", "pronunciation" => "xià kè", "chapter" => "8", "new" => "no"},
  {"front" => "尺寸", "back" => "size", "pronunciation" => "chǐ cùn", "chapter" => "8", "new" => "no"},
  {"front" => "计划", "back" => "a plan", "pronunciation" => "jì huà", "chapter" => "8", "new" => "no"},
  {"front" => "不谢", "back" => "don't mention it", "pronunciation" => "bú xiè", "chapter" => "8", "new" => "no"},
  {"front" => "工作", "back" => "to work, work", "pronunciation" => "gōng zuò", "chapter" => "8", "new" => "no"},
  {"front" => "咖啡", "back" => "coffee", "pronunciation" => "kā fēi", "chapter" => "8", "new" => "no"},
  {"front" => "还是", "back" => "or", "pronunciation" => "hái shì", "chapter" => "8", "new" => "no"},
  {"front" => "牛奶", "back" => "milk", "pronunciation" => "niú nǎi", "chapter" => "8", "new" => "no"},
  {"front" => "老师", "back" => "teacher", "pronunciation" => "lǎo shī", "chapter" => "8", "new" => "no"},
  {"front" => "地方", "back" => "district, province, area", "pronunciation" => "dì fāng", "chapter" => "8", "new" => "no"},
  {"front" => "学习", "back" => "to study", "pronunciation" => "xué xí", "chapter" => "8", "new" => "no"},
  {"front" => "一点儿", "back" => "a little bit", "pronunciation" => "yì diǎn ér", "chapter" => "8", "new" => "no"},
  {"front" => "第一颗", "back" => "first lesson", "pronunciation" => "dè yi1 kè", "chapter" => "8", "new" => "no"},
  {"front" => "对不起", "back" => "sorry", "pronunciation" => "duì bu qǐ", "chapter" => "8", "new" => "no"},
  {"front" => "请问，李小姐在家吗？", "back" => "Excuse me, is Miss Li at home?", "pronunciation" => "qǐng wèn, lǐ xiǎo jiě zài jiā ma?", "chapter" => "8", "new" => "no"},
  {"front" => "你好，马先生", "back" => "How do you do, Mr Ma.", "pronunciation" => "nǐ hǎo, mǎ xiān sheng", "chapter" => "8", "new" => "no"},
  {"front" => "请进。请坐", "back" => "Please come in and sit down.", "pronunciation" => "qǐng jìn. qǐng zuò", "chapter" => "8", "new" => "no"},
  {"front" => "你想喝什么咖啡还是茶", "back" => "What would you like to drink, coffee or tea?", "pronunciation" => "nǐ xiǎng hē shén me, kā fēi hái shì chá?", "chapter" => "8", "new" => "no"},
  {"front" => "我喝茶，不要牛奶和糖", "back" => "Tea with no milk and sugar.", "pronunciation" => "wǒ hē chà, bú yào niú nǎi hé táng", "chapter" => "8", "new" => "no"},
  {"front" => "你在什么地方工作", "back" => "Where do you work?", "pronunciation" => "nǐ zài shén me dì fāng gōng zuò", "chapter" => "8", "new" => "no"},
  {"front" => "我在大学工作", "back" => "I work at the university.", "pronunciation" => "wǒ zài dà xué gōng zuò", "chapter" => "8", "new" => "no"},
  {"front" => "你做什么", "back" => "What do you do?", "pronunciation" => "nǐ zuò shén me", "chapter" => "8", "new" => "no"},
  {"front" => "我是中文老师", "back" => "I'm a teacher of Chinese", "pronunciation" => "wǒ shì zhōng wén lǎo shī", "chapter" => "8", "new" => "no"},
  {"front" => "对不起，我不工作", "back" => "I'm sorry, I do not work.", "pronunciation" => "duì bu qǐ, wǒ bù gōng zuò", "chapter" => "8", "new" => "no"},
  {"front" => "我在大学学习", "back" => "I'm studying at a university.", "pronunciation" => "wǒ zài dà xué xué xí", "chapter" => "8", "new" => "no"},
  {"front" => "你学什么", "back" => "What do you study?", "pronunciation" => "nǐ xué shén me?", "chapter" => "8", "new" => "no"},
  {"front" => "我学中文。我会说一点儿中国话", "back" => "I study Chinese. I can speak a little bit of Chinese", "pronunciation" => "wǒ xué zhōng wén. wǒ huì shuō yì diǎn ér zhōng guó huà", "chapter" => "8", "new" => "no"},
  {"front" => "你会写中文信吗？", "back" => "Can you write a letter in Chinese？", "pronunciation" => "nǐ huì xiè zhōng wén xìn ma?", "chapter" => "8", "new" => "no"},
  {"front" => "还不会。我有信心我很快会写中文信的", "back" => "Not yet. I have confidence that I will be able to write Chinese letters soon.", "pronunciation" => "hái bú huì. wǒ yǒu xìn xīn wǒ hěn kuài huì xiè zhōng wén xìn de.", "chapter" => "8", "new" => "no"},
  {"front" => "对，你一定会", "back" => "Yes, you definately will.", "pronunciation" => "duì, nǐ yí dìng huì", "chapter" => "8", "new" => "no"},

  #lesson 9
  {"front" => "斤", "back" => "500 grams", "pronunciation" => "jīn", "chapter" => "9", "new" => "no"},
  {"front" => "近", "back" => "near", "pronunciation" => "jìn", "chapter" => "9", "new" => "no"},
  {"front" => "听", "back" => "listen", "pronunciation" => "tīng", "chapter" => "9", "new" => "no"},
  {"front" => "匠", "back" => "craftsman", "pronunciation" => "jiàng", "chapter" => "9", "new" => "no"},
  {"front" => "兵", "back" => "soldier, troops", "pronunciation" => "bīng", "chapter" => "9", "new" => "no"},
  {"front" => "所", "back" => "place", "pronunciation" => "suǒ", "chapter" => "9", "new" => "no"},
  {"front" => "新", "back" => "new", "pronunciation" => "xīn", "chapter" => "9", "new" => "no"},
  {"front" => "质", "back" => "quality", "pronunciation" => "zhì", "chapter" => "9", "new" => "no"},
  {"front" => "少", "back" => "few, little", "pronunciation" => "shǎo", "chapter" => "9", "new" => "no"},
  {"front" => "站", "back" => "station, stop", "pronunciation" => "zhàn", "chapter" => "9", "new" => "no"},
  {"front" => "再", "back" => "again, twice", "pronunciation" => "zài", "chapter" => "9", "new" => "no"},
  {"front" => "换", "back" => "to change", "pronunciation" => "huàn", "chapter" => "9", "new" => "no"},
  {"front" => "到", "back" => "to arrive", "pronunciation" => "dào", "chapter" => "9", "new" => "no"},
  {"front" => "公斤", "back" => "kilogram", "pronunciation" => "gon1 jīn", "chapter" => "9", "new" => "no"},
  {"front" => "附近", "back" => "nearby", "pronunciation" => "fù jìn", "chapter" => "9", "new" => "no"},
  {"front" => "听说", "back" => "hearsay, to hear, was told", "pronunciation" => "tīng shuō", "chapter" => "9", "new" => "no"},
  {"front" => "听见", "back" => "hear", "pronunciation" => "tīng jiàn", "chapter" => "9", "new" => "no"},
  {"front" => "听话", "back" => "be obedient", "pronunciation" => "tīng huà", "chapter" => "9", "new" => "no"},
  {"front" => "听众", "back" => "audience", "pronunciation" => "tīng zhòng", "chapter" => "9", "new" => "no"},
  {"front" => "木匠", "back" => "carpenter", "pronunciation" => "mù jiàng", "chapter" => "9", "new" => "no"},
  {"front" => "士兵", "back" => "soldier", "pronunciation" => "shì bīng", "chapter" => "9", "new" => "no"},
  {"front" => "所以", "back" => "so, therefore", "pronunciation" => "suǒ yǐ", "chapter" => "9", "new" => "no"},
  {"front" => "住所", "back" => "living place (usage)", "pronunciation" => "zhù suǒ", "chapter" => "9", "new" => "no"},
  {"front" => "厕所", "back" => "toilet", "pronunciation" => "cè suǒ", "chapter" => "9", "new" => "no"},
  {"front" => "品质", "back" => "quality, character", "pronunciation" => "pǐn zhì", "chapter" => "9", "new" => "no"},
  {"front" => "怎么", "back" => "how", "pronunciation" => "zěn me", "chapter" => "9", "new" => "no"},
  {"front" => "开车", "back" => "to drive (a car）", "pronunciation" => "kāi chē", "chapter" => "9", "new" => "no"},
  {"front" => "坐车", "back" => "to take buses", "pronunciation" => "zuò chē", "chapter" => "9", "new" => "no"},
  {"front" => "因为", "back" => "because", "pronunciation" => "yīn wèi", "chapter" => "9", "new" => "no"},
  {"front" => "车位", "back" => "parking space", "pronunciation" => "chē wèi", "chapter" => "9", "new" => "no"},
  {"front" => "火车", "back" => "train", "pronunciation" => "huǒ chē", "chapter" => "9", "new" => "no"},
  {"front" => "电车", "back" => "tram", "pronunciation" => "diàn chē", "chapter" => "9", "new" => "no"},
  {"front" => "下车", "back" => "to get off (a bus）", "pronunciation" => "xià chē", "chapter" => "9", "new" => "no"},
  {"front" => "多长", "back" => "how long", "pronunciation" => "duō cháng", "chapter" => "9", "new" => "no"},
  {"front" => "时间", "back" => "time (variation)", "pronunciation" => "shí jiān", "chapter" => "9", "new" => "no"},
  {"front" => "小时", "back" => "hour xiǎo", "pronunciation" => "shí", "chapter" => "9", "new" => "no"},
  {"front" => "去墨尔本大学怎么走？", "back" => "How to go to Melbourne University?", "pronunciation" => "gù mò er běn dà xué zěn me zǒu?", "chapter" => "9", "new" => "no"},
  {"front" => "你开车去还是坐车去", "back" => "Do you drive or take buses?", "pronunciation" => "nǐ kāi chē gù hái shì zuò chē gù?", "chapter" => "9", "new" => "no"},
  {"front" => "我坐车去，因为大学里车位很少", "back" => "I go by bus, because in the university parking spaces are few.", "pronunciation" => "wǒ zuò chē gù, yīn wèi dà xué lǐ chē wèi hěn shǎo.", "chapter" => "9", "new" => "no"},
  {"front" => "附近有个新火车站", "back" => "Nearby, there is a new train station", "pronunciation" => "fù jìn yǒu gé xīn huǒ chē zhàn.", "chapter" => "9", "new" => "no"},
  {"front" => "你可以先坐火车，再换电车在大学下车", "back" => "You can first take a train, then change to a tram and get off at the University.", "pronunciation" => "nǐ kě yǐ xiān zuò huǒ chē zài huàn diàn chē, zài dà xué xià chē.", "chapter" => "9", "new" => "no"},
  {"front" => "多长时间可以到？", "back" => "How long does it take?", "pronunciation" => "duō cháng shí jiān kě yǐ dào?", "chapter" => "9", "new" => "no"},
  {"front" => "听说一个小时左右", "back" => "From hearsay one hour approximately.", "pronunciation" => "tīng shuō yí gé xiǎo shí zuǒ yòu", "chapter" => "9", "new" => "no"},

  #lesson 10
  {"front" => "忙", "back" => "busy", "pronunciation" => "máng", "chapter" => "10", "new" => "no"},
  {"front" => "祝", "back" => "to wish", "pronunciation" => "zhù", "chapter" => "10", "new" => "no"},
  {"front" => "爸爸", "back" => "father", "pronunciation" => "bà ba", "chapter" => "10", "new" => "no"},
  {"front" => "每天", "back" => "everyday (variation)", "pronunciation" => "měi tiān", "chapter" => "10", "new" => "no"},
  {"front" => "没有", "back" => "have not", "pronunciation" => "méi yǒu", "chapter" => "10", "new" => "no"},
  {"front" => "快乐", "back" => "happy", "pronunciation" => "kuài lè", "chapter" => "10", "new" => "no"}
  ]
